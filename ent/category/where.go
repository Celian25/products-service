...
func PhotoURL(v string) predicate.Category {
	return predicate.Category(sql.FieldEQ(FieldPhotoURL, v))
}
...
func PhotoURLHasPrefix(v string) predicate.Category {
	return predicate.Category(sql.FieldHasPrefix(FieldPhotoURL, v))
}
...
func PhotoURLEqualFold(v string) predicate.Category {
	return predicate.Category(sql.FieldEqualFold(FieldPhotoURL, v))
}
...
func PhotoURLContainsFold(v string) predicate.Category {
	return predicate.Category(sql.FieldContainsFold(FieldPhotoURL, v))
}
