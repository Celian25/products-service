...
func (_u *CategoryUpdate) SetPhotoURL(v string) *CategoryUpdate {
	_u.mutation.SetPhotoURL(v)
	return _u
}

// SetNillablePhotoURL sets the "photo_url" field if the given value is not nil.
func (_u *CategoryUpdate) SetNillablePhotoURL(v *string) *CategoryUpdate {
	if v != nil {
		_u.SetPhotoURL(*v)
	}
	return _u
...
func (_u *CategoryUpdate) ClearPhotoURL() *CategoryUpdate {
...
func (_u *CategoryUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.PhotoURL(); ok {
		_spec.SetField(category.FieldPhotoURL, field.TypeString, value)
	}
	if _u.mutation.PhotoURLCleared() {
		_spec.ClearField(category.FieldPhotoURL, field.TypeString)
	}
...
// SetPhotoURL sets the "photo_url" field.
func (_u *CategoryUpdateOne) SetPhotoURL(v string) *CategoryUpdateOne {
	_u.mutation.SetPhotoURL(v)
	return _u
}

// SetNillablePhotoURL sets the "photo_url" field if the given value is not nil.
func (_u *CategoryUpdateOne) SetNillablePhotoURL(v *string) *CategoryUpdateOne {
	if v != nil {
		_u.SetPhotoURL(*v)
	}
	return _u
...
// ClearPhotoURL clears the value of the "photo_url" field.
func (_u *CategoryUpdateOne) ClearPhotoURL() *CategoryUpdateOne {
	_u.mutation.ClearPhotoURL()
	return _u
}
