...
func (_c *FilterCreate) SetFilterTypeID(id int) *FilterCreate {
	_c.mutation.SetFilterTypeID(id)
	return _c
}

// SetFilterType sets the "filter_type" edge to the FilterType entity.
func (_c *FilterCreate) SetFilterType(v *FilterType) *FilterCreate {
	return _c.SetFilterTypeID(v.ID)
}

// AddProductIDs adds the "products" edge to the Product entity by IDs.
func (_c *FilterCreate) AddProductIDs(ids ...int) *FilterCreate {
	_c.mutation.AddProductIDs(ids...)
	return _c
}

// AddProducts adds the "products" edges to the Product entity.
func (_c *FilterCreate) AddProducts(v ...*Product) *FilterCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *FilterCreate) check() error {
	...
	if len(_c.mutation.FilterTypeIDs()) == 0 {
		return &ValidationError{Name: "filter_type", err: errors.New(`ent: missing required edge "Filter.filter_type"`)}
	}
	return nil
}
...
func (_c *FilterCreate) createSpec() (*Filter, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.FilterTypeIDs(); len(nodes) > 0 {
		...
		_node.filter_filter_type = &nodes[0]
